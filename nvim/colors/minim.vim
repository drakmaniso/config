...
hi! link elmLetBlockDefinition Keyword
...
if &background ==# 'dark'
	...
	hi Cursor       ctermfg=NONE ctermbg=0    cterm=NONE
	hi Title        ctermfg=NONE ctermbg=NONE cterm=bold
	hi VertSplit    ctermfg=8    ctermbg=NONE cterm=NONE
	hi StatusLine   ctermfg=4    ctermbg=0    cterm=reverse
	hi StatusLineNC ctermfg=8    ctermbg=0    cterm=reverse
	...
	hi IncSearch    ctermfg=9    ctermbg=NONE cterm=NONE
	hi QuickFixLine cterm=reverse
	hi PMenu        ctermfg=0    ctermbg=14   cterm=NONE
	hi PMenuSbar    ctermfg=0    ctermbg=14   cterm=NONE
	...
	hi Comment        ctermfg=5    ctermbg=NONE cterm=italic
	...
	hi Include	   ctermfg=2    ctermbg=NONE cterm=NONE
