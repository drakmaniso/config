...
mytextclock.format = "%k:%M"
beautiful.calendar_style = {border_width = 0}
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, "Mod1"    }, "u", awful.client.urgent.jumpto,
...
clientkeys = gears.table.join(
    ...
    awful.key({ modkey, "Shift" }, "j",
        function ()
            ...
            -- get previous tag (modulo 9 excluding 0 to wrap from 1 to 4)
    ...
    awful.key({ modkey, "Shift" }, "l",
        function ()
            ...
            -- get next tag (modulo 9 excluding 0 to wrap from 4 to 1)
...
for i = 1, 4 do
    globalkeys = gears.table.join(globalkeys,
        -- View tag only.
        awful.key({ modkey }, mytagkeys[i], -- "#" .. i + 9,
                  function ()
        ...
        -- Move client to tag.
        awful.key({ modkey, "Shift" }, mytagkeys[i], -- "#" .. i + 9,
                  function ()
                      if client.focus then
