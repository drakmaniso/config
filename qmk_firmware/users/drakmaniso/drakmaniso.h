...
#define QWERTY_4     MY_LCTL, MY_LALT, MY_LGUI, KC_SPC,  KC_LSFT, SP_LAYA,     SP_SHFT, LAYER_B, KC_WH_D, KC_WH_U, MY_RALT, MY_RCTL

#define LAYER_A_1    KC_LBRC, KC_7,    KC_8,    KC_9,    KC_RBRC, KC_DEL,      ADJUST,  KC_PGUP, CT_LEFT, KC_UP,   CT_RGHT, KC_GRV
#define LAYER_A_2    KC_LPRN, KC_4,    KC_5,    KC_6,    KC_RPRN, KC_ENT,      KC_BSPC, KC_PGDN, KC_LEFT, KC_DOWN, KC_RGHT, KC_QUOT
#define LAYER_A_3    KC_0,    KC_1,    KC_2,    KC_3,    KC_MINS, KC_ESC,      KC_TAB,  KC_EQL,  KC_HOME, KC_INS,  KC_END,  KC_BSLS
#define LAYER_A_4    MY_LCTL, MY_LALT, MY_LGUI, KC_DOT,  KC_RSFT, XXXXXXX,     SP_SHFT, ADJUST,  KC_WH_D, KC_WH_U, MY_RALT, MY_RCTL

#define LAYER_B_1    KC_PSLS, KC_KP_7, KC_KP_8, KC_KP_9, KC_PMNS, KC_DEL,      ADJUST,  KC_BRK,  KC_F1,   KC_F2,   KC_F3,   KC_F4
...
#define ADJUST_1     RESET,   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,     XXXXXXX, KC_WH_U, XXXXXXX, KC_MS_U, XXXXXXX, RESET
...
#define ADJUST_4     MY_LCTL, MY_LALT, MY_LGUI, KC_LSFT, XXXXXXX, XXXXXXX,     KC_BTN1, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX
