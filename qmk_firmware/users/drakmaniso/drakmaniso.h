...
#define QWERTY_3     KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    ADJUST,      KC_DEL,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH
#define QWERTY_4     KC_LCTL, KC_LALT, KC_LGUI, KC_LSFT, SYMBOLS, KC_SPC,      KC_ENT,  KC_RSFT, FUNCS,   KC_RGUI, KC_RALT, KC_RCTL

#define SYMBOLS_1    _______, KC_LBRC, KC_PGUP, KC_RBRC, KC_GRV,  KC_ESC,      ADJUST,  KC_HOME, CT_LEFT, KC_UP,   CT_RGHT, KC_END
#define SYMBOLS_2    KC_BSLS, KC_LPRN, KC_PGDN, KC_RPRN, KC_QUOT, KC_TAB,      KC_BSPC, KC_MINS, KC_LEFT, KC_DOWN, KC_RGHT, KC_EQL
#define SYMBOLS_3    KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    ADJUST,      KC_DEL,  KC_6,    KC_7,    KC_8,    KC_9,    KC_0
#define SYMBOLS_4    KC_LCTL, KC_LALT, KC_LGUI, KC_LSFT, SYMBOLS, KC_SPC,      KC_ENT,  KC_RSFT, XXXXXXX, KC_RGUI, KC_RALT, KC_RCTL

#define NUMPAD_1     KC_PSLS, KC_KP_7, KC_KP_8, KC_KP_9, KC_PAST, KC_ESC,      ADJUST,  KC_PSLS, KC_KP_7, KC_KP_8, KC_KP_9, KC_PAST
#define NUMPAD_2     KC_PDOT, KC_KP_4, KC_KP_5, KC_KP_6, KC_PMNS, KC_TAB,      KC_BSPC, KC_KP_0, KC_KP_4, KC_KP_5, KC_KP_6, KC_PMNS
#define NUMPAD_3     KC_KP_0, KC_KP_1, KC_KP_2, KC_KP_3, KC_PPLS, ADJUST,      KC_INS,  KC_PDOT, KC_KP_1, KC_KP_2, KC_KP_3, KC_PPLS
#define NUMPAD_4     KC_LCTL, KC_LALT, KC_LGUI, KC_NLCK, KC_LSFT, KC_SPC,      KC_PENT, KC_RSFT, XXXXXXX, KC_NLCK, KC_RALT, KC_RCTL

#define FUNCS_1      KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_PSCR, KC_ESC,      ADJUST,  KC_PSLS, KC_KP_7, KC_KP_8, KC_KP_9, KC_PAST
#define FUNCS_2      KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_SLCK, KC_TAB,      KC_BSPC, KC_KP_0, KC_KP_4, KC_KP_5, KC_KP_6, KC_PMNS
#define FUNCS_3      KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_BRK,  ADJUST,      KC_NLCK, KC_PDOT, KC_KP_1, KC_KP_2, KC_KP_3, KC_PPLS
#define FUNCS_4      KC_LCTL, KC_LALT, KC_LGUI, KC_LSFT, XXXXXXX, KC_SPC,      KC_ENT,  KC_RSFT, FUNCS,   KC_RGUI, KC_RALT, KC_RCTL
