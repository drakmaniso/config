...
#define QWERTY_3     KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_ESC,      KC_DEL,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH
#define QWERTY_4     KC_LCTL, KC_LALT, KC_LGUI, NUMPAD,  KC_LSFT, KC_SPC,      KC_ENT,  SYMBOLS, FUNCS,   KC_RGUI, KC_RALT, KC_RCTL

#define SYMBOLS_1    _______, KC_LBRC, KC_PGUP, KC_RBRC, KC_GRV,  ADJUST,      ADJUST,  KC_HOME, CT_LEFT, KC_UP,   CT_RGHT, KC_END
#define SYMBOLS_2    KC_BSLS, KC_LPRN, KC_PGDN, KC_RPRN, KC_QUOT, KC_TAB,      KC_BSPC, KC_MINS, KC_LEFT, KC_DOWN, KC_RGHT, KC_EQL
#define SYMBOLS_3    KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_ESC,      KC_DEL,  KC_6,    KC_7,    KC_8,    KC_9,    KC_0
...
#define NUMPAD_2     KC_PDOT, KC_KP_4, KC_KP_5, KC_KP_6, KC_PMNS, KC_TAB,      KC_BSPC, KC_PDOT, KC_KP_4, KC_KP_5, KC_KP_6, KC_PMNS
#define NUMPAD_3     KC_KP_0, KC_KP_1, KC_KP_2, KC_KP_3, KC_PPLS, KC_ESC,      KC_DEL,  KC_KP_0, KC_KP_1, KC_KP_2, KC_KP_3, KC_PPLS
#define NUMPAD_4     KC_LCTL, KC_LALT, KC_LGUI, KC_NLCK, KC_LSFT, KC_SPC,      KC_PENT, KC_RSFT, XXXXXXX, KC_RGUI, KC_RALT, KC_RCTL

#define FUNCS_1      KC_F12,  XXXXXXX, KC_WH_U, KC_BTN3, KC_BTN4, KC_ESC,      ADJUST,  XXXXXXX, XXXXXXX, KC_MS_U, KC_BRK,  KC_PSCR
#define FUNCS_2      KC_F11,  KC_BTN2, KC_WH_D, KC_BTN1, KC_BTN5, KC_TAB,      KC_BSPC, XXXXXXX, KC_MS_L, KC_MS_D, KC_MS_R, KC_SLCK
#define FUNCS_3      KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_ESC,      KC_INS,  KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10
#define FUNCS_4      KC_LCTL, KC_LALT, KC_LGUI, XXXXXXX, KC_LSFT, KC_SPC,      KC_ENT,  KC_RSFT, FUNCS,   KC_RGUI, KC_RALT, KC_RCTL
