...
#define SYMBOLS_1    KC_BSLS, KC_LBRC, KC_PGUP, KC_RBRC, KC_GRV,  KC_ESC,      KC_DEL,  KC_HOME, CT_LEFT, KC_UP,   CT_RGHT, KC_END
#define SYMBOLS_2    KC_INS,  KC_LPRN, KC_PGDN, KC_RPRN, KC_QUOT, KC_TAB,      KC_BSPC, KC_MINS, KC_LEFT, KC_DOWN, KC_RGHT, KC_EQL
...
#define NUMPAD_1     KC_PSLS, KC_KP_7, KC_KP_8, KC_KP_9, KC_PAST, KC_NLCK,     KC_DEL,  KC_PSLS, KC_KP_7, KC_KP_8, KC_KP_9, KC_PAST
#define NUMPAD_2     KC_PDOT, KC_KP_4, KC_KP_5, KC_KP_6, KC_PMNS, KC_TAB,      KC_BSPC, KC_PDOT, KC_KP_4, KC_KP_5, KC_KP_6, KC_PMNS
#define NUMPAD_3     KC_KP_0, KC_KP_1, KC_KP_2, KC_KP_3, KC_PPLS, ADJUST,      ADJUST,  KC_KP_0, KC_KP_1, KC_KP_2, KC_KP_3, KC_PPLS
#define NUMPAD_4     KC_LCTL, KC_LALT, KC_LGUI, NUMPAD,  KC_LSFT, KC_SPC,      KC_PENT, KC_RSFT, XXXXXXX, KC_RGUI, KC_RALT, KC_RCTL

#define FUNCS_1      KC_F12,  XXXXXXX, KC_WH_U, KC_BTN3, KC_BTN4, KC_ESC,      KC_INS,  XXXXXXX, XXXXXXX, KC_MS_U, KC_BRK,  KC_PSCR
#define FUNCS_2      KC_F11,  KC_BTN2, KC_WH_D, KC_BTN1, KC_BTN5, KC_TAB,      KC_BSPC, XXXXXXX, KC_MS_L, KC_MS_D, KC_MS_R, KC_SLCK
#define FUNCS_3      KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   ADJUST,      ADJUST,  KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10
