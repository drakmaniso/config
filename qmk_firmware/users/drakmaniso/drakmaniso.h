...
#define SYMBOLS_1    KC_BSLS, KC_LBRC, KC_PGUP, KC_RBRC, KC_GRV,  KC_INS,      KC_DEL,  KC_HOME, KC_LPRN, KC_UP,   KC_RPRN, KC_END
#define SYMBOLS_2    KC_ESC,  CT_LEFT, KC_PGDN, CT_RGHT, KC_QUOT, KC_TAB,      KC_BSPC, KC_MINS, KC_LEFT, KC_DOWN, KC_RGHT, KC_EQL
